    ...
    <div className="w-full flex items-center justify-around sticky border-b shadow-sm">
      ...
      {isMenuOpen ? (
        <ClickAwayListener onClickAway={handleClickAway}>
          <div className=" fixed top-0 left-0 h-full w-80 bg-gray-300 flex flex-col  pt-8  z-50">
            <div className="w-72 bg-indigo-900 h-56 rounded-xl flex flex-col justify-center items-center m-3">
            ...
            <div className="flex flex-col gap-10 items-start mt-4 ml-8 text-indigo-900 font-bold">
              <Link to="/">Home</Link>
